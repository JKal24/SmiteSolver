...
@ComponentScan(basePackages={"com.astro.smitebasic.api", "com.astro.SmiteSolver.data", "com.astro.SmiteSolver.controller"})
...
@EntityScan(basePackages={"com.astro.smitebasic.objects.characters.auxiliary", "com.astro.smitebasic.objects.characters",
		...
		"com.astro.smitebasic.objects.player.matches", "com.astro.smitebasic.objects.session", "com.astro.SmiteSolver.object"})
