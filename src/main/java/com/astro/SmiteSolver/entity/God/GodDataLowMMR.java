...
@Entity
@Table(name="god_data_low_mmr")
public class GodDataLowMMR {
    ...
    public GodDataLowMMR(LocalDate date, Integer godID, Map<String, Integer> skinsUsed, Integer matchesPlayed, Integer wins,
