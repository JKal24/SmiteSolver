...
public class PerformanceDataHighMMR {
    ...
    public PerformanceDataHighMMR(Integer godID, String godName, BigDecimal winRate, BigDecimal newPatchWinRate, BigDecimal pickRate,
